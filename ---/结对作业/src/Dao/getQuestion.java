...
public class getQuestion {
		...
		public static boolean issame(int c,int[] T,char[] Fuhao1,char[] Fuhao2,char[] Fuhao3,int[] n1,int[] n11,int[] n111,int[] n2,int[] n22,int[] n222,int[] n3,int[] n33,int[] n333,int[] n4,int[] n44,int[] n444) {
			int d;
			if(T[c]>0)	//第一类
				for(d=0;d<c;d++) 	
		...
		public boolean getQuestion() {
			...
			for(c=0;c<Qnumber;c++) {
				...
				if(fuhao(0)==1) {
					...
					if(issame(c,T,Fuhao1,Fuhao2,Fuhao3,n1,n11,n111,n2,n22,n222,n3,n33,n333,n4,n44,n444)) {
				 ...
				 */
					 ...
					 * 判断运算是否重复,重复则重新生成题目
					 */
					if(issame(c,T,Fuhao1,Fuhao2,Fuhao3,n1,n11,n111,n2,n22,n222,n3,n33,n333,n4,n44,n444)|(answerZi<0)) {
						c--;s.delete(0,s.length());	//清空s	//System.out.print(c+"   "+d+"   "+s.toString()+"\n");s.delete(0,s.length());	//清空s	
					}else {
						str[c] = s.toString();
